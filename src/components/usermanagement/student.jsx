        ...
        return (
            <div>
                ...
                <section className="login-page section-b-space">
                    ...
                    <h3 className="text-left"><i className="mdi mdi-table-edit"/>STUDENT</h3>
                        <div className="row">
                            ...
                            <div className="col-lg-9 right-login">
                                <div className="theme-card authentication-right">
                                    ...
                                    <MuiThemeProvider>
                                    <MUIDataTable
                                        title={<div>List Student <Button size="sm" color="primary" onClick={this.addStudent}><i className="fa fa-plus"></i>&nbsp;Add Student</Button></div>}
