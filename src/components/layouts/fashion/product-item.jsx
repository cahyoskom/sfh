        ...
        <div className='img-wrapper'>
          ...
          <div className='front'>
            <Link to={`${process.env.PUBLIC_URL}/left-sidebar/product/${product.id}`}>
              <img src={`${this.state.image ? this.state.image : product.variants[0].images}`} className='img-fluid' alt='' />
            </Link>
          </div>
          <div className='cart-info cart-wrap'>
            ...
            <a href='#' data-toggle='modal' data-target='#quick-view' title='Quick View' onClick={this.onOpenModal}>
