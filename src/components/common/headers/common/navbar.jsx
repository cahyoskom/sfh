      ...
      <div>
        <nav id="main-nav">
          ...
          >
            ...
            <li className="mega">
              <Link to={`${process.env.PUBLIC_URL}/`}>{translate("home")}</Link>
            </li>
            {/* <li className='mega'>
              <a href='#'>
                {translate('features')}
                    ...
                    <div className='row'>
                      <div className='col-xl-4'>
                        <Link to={`${process.env.PUBLIC_URL}/blog/blog-page`}>
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/blog-page.jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-4'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/blog(right-sidebar).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-4'>
                        <Link to={`${process.env.PUBLIC_URL}/blog/details`}>
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/blog-detail.jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-4'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/category-page.jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-4'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/category-page(right).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-4'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/category-page(no-sidebar).jpg`}
                            alt=''
                          />
                    ...
                    <div className='row'>
                      <div className='col-xl-3'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/product-page(left-sidebar).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-3'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/product-page(right-sidebar).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-3'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/product-page(no-sidebar).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-3'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/product-page(3-col-left).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-3'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/product-page(3-col-right).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-3'>
                        <Link to={`${process.env.PUBLIC_URL}/column/product/1`}>
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/product-page(3-column).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-3'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/product-page(left-image).jpg`}
                            alt=''
                          />
                      ...
                      <div className='col-xl-3'>
                        <Link
                          ...
                          <img
                            src={`${process.env.PUBLIC_URL}/assets/images/feature/product-page(right-image).jpg`}
                            alt=''
                          />
            ...
            {/* <li>
              ...
              <ul>
                ...
                <li>
                  <Link to={`${process.env.PUBLIC_URL}/pages/loginPage`}>
                    {translate('signin')}
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to={`${process.env.PUBLIC_URL}/pages/forget-password`}>
                  ...
                  <div className='container'>
                    <div className='row'>
                      <div className='col mega-box'>
                        <div className='link-section'>
                          <div className='menu-title'>
                            <h5>{translate('mens_fashion')}</h5>
                          </div>
                          <div className='menu-content'>
                            <ul>
                              <li>
                                <a href='#'>{translate('sports_wear')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('top')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('bottom')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('ethic_wear')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('sports_wear')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('shirts')}</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div className='col mega-box'>
                        <div className='link-section'>
                          <div className='menu-title'>
                            <h5>{translate('women_fashion')}</h5>
                          </div>
                          <div className='menu-content'>
                            <ul>
                              <li>
                                <a href='#'>{translate('dresses')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('skirts')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('westarn_wear')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('ethnic_wear')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('sport_wear')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('bottom_wear')}</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div className='col mega-box'>
                        <div className='link-section'>
                          <div className='menu-title'>
                            <h5>{translate('men_accessories')}</h5>
                          </div>
                          <div className='menu-content'>
                            <ul>
                              <li>
                                <a href='#'>{translate('ties')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('cufflinks')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('pockets_squares')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('helmets')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('scarves')}</a>
                              </li>
                              <li>
                                <a href='#'>{translate('phone_cases')}</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div className='row banner-padding'>
                    <div className='col-xl-6'>
                      <a href='#' className='mega-menu-banner'>
                        <img
                          src={`${process.env.PUBLIC_URL}/assets/images/mega-menu/1.jpg`}
