...
class Role extends Component {
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            return (
                            <div>
                                <Button color="primary" size="sm" onClick={() => this.giveARole(value) }>Give a role</Button>&nbsp;
    ...
    componentDidMount(){
        let { adminGetUserList, adminGetRoleList, adminGetDataSourceClass, adminGetDataSourceSubject, adminGetDataSourceGroup, adminGetDataSourceStudent } =this.props;
        ...
        return (
            <div>
                ...
                <section className="login-page section-b-space">
                    ...
                    <h3 className="text-left"><i className="mdi mdi-table-edit"/>ROLE</h3>
                        <div className="row">
