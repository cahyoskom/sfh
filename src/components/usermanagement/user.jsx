        ...
        },
        {
          ...
          options: {
            ...
            customBodyRender: (value, tableMeta, updateValue) => {
              return (
                <div>
                  <Link to={`${process.env.PUBLIC_URL}/usermanagement/user/` + value}>
                  ...
                  <MuiThemeProvider>
                    <MUIDataTable
                      title={
                        <div>
                          List User
                          <Button size='sm' color='primary' onClick={this.addUser}>
                            <i className='fa fa-plus'></i>&nbsp;Add User
                          </Button>
                          &nbsp;
                          <Button size='sm' color='secondary' onClick={this.uploadCsv}>
                            <i className='fa fa-plus'></i>&nbsp;Upload CSV
                          </Button>
                        </div>
                      }
...
export default connect(mapStateToProps, { ...actions })(withTranslate(User));
