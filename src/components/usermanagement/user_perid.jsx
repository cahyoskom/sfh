...
class UserPerId extends Component {
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            ...
                            <div>
                                {/* <Select
                                    defaultValue={adminState.group.dataSourceGroup.filter(option => option.value === value)}
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            ...
                            <div>
                                {/* <Select
                                    defaultValue={adminState.class.dataSourceClass.filter(option => option.value === value)}
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            ...
                            <div>
                                {/* <Select
                                    defaultValue={adminState.subject.dataSourceSubject.filter(option => option.value === value)}
                ...
                },
                {
                    ...
                    options: {
                        ...
                        customBodyRender: (value, tableMeta, updateValue) => {
                            ...
                            <div>
                                {/* <Select
                                    defaultValue={adminState.student.dataSourceStudent.filter(option => option.value === value)}
    ...
    componentDidMount(){
        let { adminSetUrlPath, adminSetModalFormUserRole,
            adminGetUserById, adminGetDataSourceClass, 
            adminGetDataSourceSubject, adminGetDataSourceGroup, 
            adminGetDataSourceStudent, adminGetRoleByUserId } =this.props;
            ...
            <div>
                ...
                <section className="login-page section-b-space">
                    <div className="container">
                        <h3 className="text-left"><i className="mdi mdi-table-edit"/>Detail User : {adminState.user.dataUserById.user_name}</h3>
                        <div className="row">
                            ...
                            <div className="col-lg-12">
                                <div className="theme-card authentication-right">
                                    ...
                                    <MuiThemeProvider>
                                    <MUIDataTable
                                        title={<div><Button color="primary" size="sm" onClick={() => this.giveARole(this.props.match.params.id) }>+ Add Role</Button></div>}
                                        data={adminState.role.dataRoleById}
