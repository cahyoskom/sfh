    ...
    return (
      <footer className='footer-light'>
              ...
              <div className='col offset-xl-1'>
                <div className='sub-title'>
                  ...
                  <div className='footer-contant'>
                    <ul>
                      <li>
                        <Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`}>womens</Link>
                      </li>
                      <li>
                        <Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`}>clothing</Link>
                      </li>
                      <li>
                        <Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`}>accessories</Link>
                      </li>
                      <li>
                        <Link to={`${process.env.PUBLIC_URL}/left-sidebar/collection`}>featured</Link>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className='row'>
              <div className='col-xl-6 col-md-6 col-sm-12'>
                <div className='footer-end'>
                  <p>
                    <i className='fa fa-copyright' aria-hidden='true'></i> 2018-19 themeforest powered by pixelstrap
                  </p>
                </div>
              </div>
              <div className='col-xl-6 col-md-6 col-sm-12'>
        ...
        <div className='color-picker' style={color_style}>
          <a href='#' className='handle' onClick={this.showHideColor.bind(this)}>
