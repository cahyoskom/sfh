                            ...
                            <Col md={12}>
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  id="class_level"
                                  defaultValue={
                                    adminState.class.form.class_level
                                  }
                                  onChange={(e) =>
                                    adminSetModalFormClass(
                                      "class_level",
                                      e.target.value
                                    )
                                  }
                              ...
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  id="class_parallel"
                                  defaultValue={
                                    adminState.class.form.class_parallel
                                  }
                                  onChange={(e) => {
                                    adminSetModalFormClass(
                                      "class_parallel",
                              ...
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  id="class_name"
                                  defaultValue={
                                    adminState.class.form.class_name
                                  }
...
export default connect(mapStateToProps, { ...actions })(withTranslate(Class));
