...
ALTER TABLE `m_class` ADD `note` VARCHAR(200) NULL DEFAULT NULL AFTER `avatar`;
...
ALTER TABLE `m_class_member` ADD `link_status` TINYINT(4) NOT NULL DEFAULT '0' AFTER `sec_group_id`;
