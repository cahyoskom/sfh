...
# Database: sfh-dev
# Generation Time: 2020-09-14 9:41:56 AM +0000
# ************************************************************
...
# Dump of table ads_m_app
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ads_m_app`;

CREATE TABLE `ads_m_app` (
...
# Dump of table ads_m_app_page
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ads_m_app_page`;

CREATE TABLE `ads_m_app_page` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `m_ads_app_id` int(11) unsigned DEFAULT NULL,
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  ...
  `updated_by` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `m_ads_app_id` (`m_ads_app_id`),
  CONSTRAINT `ads_m_app_page_ibfk_1` FOREIGN KEY (`m_ads_app_id`) REFERENCES `ads_m_app` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table ads_m_payment_method
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ads_m_payment_method`;

CREATE TABLE `ads_m_payment_method` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `status` tinyint(4) NOT NULL DEFAULT '0',
  `created_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
# Dump of table ads_m_payment_type
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ads_m_payment_type`;

CREATE TABLE `ads_m_payment_type` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `status` tinyint(4) NOT NULL DEFAULT '0',
  `created_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
# Dump of table ads_m_rates
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ads_m_rates`;

CREATE TABLE `ads_m_rates` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `ads_m_spot_id` int(11) unsigned NOT NULL,
  `price` mediumint(9) unsigned NOT NULL,
  `frequence` smallint(6) unsigned NOT NULL,
  `duration` smallint(6) unsigned NOT NULL DEFAULT '0',
  `duration_unit` enum('second','minute') NOT NULL DEFAULT 'second',
  `status` tinyint(4) NOT NULL DEFAULT '0',
  `created_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created_by` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT 'SYSTEM',
  `updated_date` datetime DEFAULT NULL,
  `updated_by` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ads_m_spot_id` (`ads_m_spot_id`),
  CONSTRAINT `ads_m_rates_ibfk_1` FOREIGN KEY (`ads_m_spot_id`) REFERENCES `ads_m_spot` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table ads_m_spot
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ads_m_spot`;

CREATE TABLE `ads_m_spot` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `ads_m_app_page` int(10) unsigned DEFAULT NULL,
  ...
  `updated_by` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ads_m_app_page` (`ads_m_app_page`),
  CONSTRAINT `ads_m_spot_ibfk_1` FOREIGN KEY (`ads_m_app_page`) REFERENCES `ads_m_app_page` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table ads_t_order
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ads_t_order`;

CREATE TABLE `ads_t_order` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `sec_user_id` int(11) unsigned NOT NULL,
  `ads_m_rates_id` int(11) unsigned NOT NULL,
  `content` longtext CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `content_type` enum('image','audio','video') NOT NULL DEFAULT 'image',
  `start_datetime` datetime NOT NULL,
  `end_datetime` datetime NOT NULL,
  `deal_price` smallint(6) unsigned NOT NULL,
  `deal_frequence` smallint(6) unsigned NOT NULL,
  `deal_duration` smallint(6) unsigned NOT NULL,
  `deal_duration_unit` enum('second','minute') NOT NULL DEFAULT 'second',
  ...
  KEY `ads_m_rates_id` (`ads_m_rates_id`),
  CONSTRAINT `ads_t_order_ibfk_1` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `ads_t_order_ibfk_2` FOREIGN KEY (`ads_m_rates_id`) REFERENCES `ads_m_rates` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table ads_t_order_payment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `ads_t_order_payment`;

CREATE TABLE `ads_t_order_payment` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `sec_user_id` int(11) unsigned DEFAULT NULL,
  `ads_t_order_id` int(11) unsigned DEFAULT NULL,
  `ads_m_payment_type_id` int(11) unsigned DEFAULT NULL,
  `ads_m_payment_method_id` int(11) unsigned DEFAULT NULL,
  ...
  `status` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `ads_t_order_id` (`ads_t_order_id`),
  KEY `ads_m_payment_type_id` (`ads_m_payment_type_id`),
  KEY `ads_m_payment_method_id` (`ads_m_payment_method_id`),
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `ads_t_order_payment_ibfk_1` FOREIGN KEY (`ads_t_order_id`) REFERENCES `ads_t_order` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `ads_t_order_payment_ibfk_2` FOREIGN KEY (`ads_m_payment_type_id`) REFERENCES `ads_m_payment_type` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `ads_t_order_payment_ibfk_3` FOREIGN KEY (`ads_m_payment_method_id`) REFERENCES `ads_m_payment_method` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `ads_t_order_payment_ibfk_4` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `m_notification_type` (
  ...
  `activity` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
  `action_yes` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
...
LOCK TABLES `m_notification_type` WRITE;
/*!40000 ALTER TABLE `m_notification_type` DISABLE KEYS */;

INSERT INTO `m_notification_type` (`id`, `type`, `content`, `content_url`, `activity`, `action_yes`, `action_no`, `status`, `created_date`, `created_by`, `updated_date`, `updated_by`)
VALUES
	(1,X'434C4153535F4143434550545F55534552',X'416E646120646920746572696D61206469206B656C617320313241','/',X'50656D6265726974616875616E2070656E6572696D61616E206B656C6173',X'2F',X'2F',1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL),
	(2,X'434C4153535F4348414E47455F494E464F',X'6A616D206B656C617320616E64612062657275626168206D656E6A616469206A616D20','/',X'50656D6265726974616875616E2070656E6767616E7469616E206B656C6173',X'2F',X'2F',1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL),
	(3,X'434C4153535F52454A4543545F55534552',X'416E6461206469746F6C616B20756E74756B20626572676162756E672070616461','/notification/setting',X'50656D6265726974616875616E206469746F6C616B2070616461206B656C6173',X'2F6E6F74696669636174696F6E2F73657474696E67',X'2F6E6F74696669636174696F6E2F73657474696E67',1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL),
	(4,X'434C4153535F4143434550545F5343484F4F4C',X'416E6461206469746572696D6120646920','/notification/setting',X'50656D6265726974616875616E2070656E6572696D61616E206B656C6173',X'2F6E6F74696669636174696F6E2F73657474696E67',X'2F6E6F74696669636174696F6E2F73657474696E67',1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL),
	(5,X'5343484F4F4C5F4143434550545F434C415353',X'6B656C617320616E6461206469746572696D612064692073656B6F6C616820','/notification/setting',X'50656D6265726974616875616E2070656E6572696D61616E206B656C61732064692073656B6F6C6168',X'2F6E6F74696669636174696F6E2F73657474696E67',X'2F6E6F74696669636174696F6E2F73657474696E67',1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL),
	(6,X'5343484F4F4C5F4348414E47455F494E464F',X'53656B6F6C616820616E64612073656B6172616E67206265726E616D61','/notification/setting',X'50656D6265726974616875616E2070657275626168616E206E616D612073656B6F6C6168',X'2F6E6F74696669636174696F6E2F73657474696E67',X'2F6E6F74696669636174696F6E2F73657474696E67',1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL),
	(7,X'555345525F524551554553545F434C415353',X'496E67696E20626572676162756E67206B6520','/notification',X'50656D6265726974616875616E207065726D696E7461616E20626572676162756E67',X'2F6E6F74696669636174696F6E',X'2F6E6F74696669636174696F6E',1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL),
	(8,X'434C4153535F52454D4F56455F55534552',X'6D656E6768617075732075736572',NULL,X'50656D6265726974616875616E2070656E676861707573616E20757365722070616461206B656C6173',NULL,NULL,1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL),
	(9,X'434C4153535F524551554553545F5343484F4F4C',X'6D656D696E746120626572676162756E672064656E67616E2073656B6F6C6168',NULL,X'50656D6265726974616875616E207065726D696E7461616E206B656C617320706164612073656B6F6C6168',NULL,NULL,1,'2020-09-14 16:41:26',X'53595354454D',NULL,NULL);

/*!40000 ALTER TABLE `m_notification_type` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `t_class` (
  ...
  CONSTRAINT `t_class_ibfk_1` FOREIGN KEY (`t_school_id`) REFERENCES `t_school` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;



# Dump of table t_class_forum
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_forum`;
...
CREATE TABLE `t_class_forum` (
  ...
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `t_class_forum_ibfk_1` FOREIGN KEY (`t_class_id`) REFERENCES `t_class` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_forum_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_class_forum_comment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_forum_comment`;
...
CREATE TABLE `t_class_forum_comment` (
  ...
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `t_class_forum_comment_ibfk_1` FOREIGN KEY (`t_class_forum_id`) REFERENCES `t_class_forum` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_forum_comment_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_class_forum_comment_mention
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_forum_comment_mention`;
...
CREATE TABLE `t_class_forum_comment_mention` (
  ...
  `updated_by` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `t_class_forum_comment_id` (`t_class_forum_comment_id`),
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `t_class_forum_comment_mention_ibfk_1` FOREIGN KEY (`t_class_forum_comment_id`) REFERENCES `t_class_forum_comment` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_forum_comment_mention_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `t_class_forum_mention`;
...
CREATE TABLE `t_class_member` (
  ...
  CONSTRAINT `t_class_member_ibfk_1` FOREIGN KEY (`t_class_id`) REFERENCES `t_class` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_member_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_member_ibfk_3` FOREIGN KEY (`sec_group_id`) REFERENCES `sec_group` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
CREATE TABLE `t_class_task` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `t_class_subject_id` int(11) unsigned DEFAULT NULL,
  `t_class_id` int(11) unsigned NOT NULL,
...
# Dump of table t_class_task_collection_comment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_task_collection_comment`;
...
# Dump of table t_class_todo
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_todo`;
...
CREATE TABLE `t_class_todo` (
  ...
  CONSTRAINT `t_class_todo_ibfk_1` FOREIGN KEY (`t_class_id`) REFERENCES `t_class` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_todo_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_todo_ibfk_3` FOREIGN KEY (`m_recurrent_id`) REFERENCES `m_recurrent` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_class_todo_answer
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_todo_answer`;
...
CREATE TABLE `t_class_todo_answer` (
  ...
  `updated_by` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `t_class_todo_id` (`t_class_todo_id`),
  KEY `t_class_todo_detail_id` (`t_class_todo_detail_id`),
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `t_class_todo_answer_ibfk_1` FOREIGN KEY (`t_class_todo_id`) REFERENCES `t_class_todo` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_todo_answer_ibfk_2` FOREIGN KEY (`t_class_todo_detail_id`) REFERENCES `t_class_todo_detail` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_todo_answer_ibfk_3` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_class_todo_detail
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_todo_detail`;
...
CREATE TABLE `t_class_todo_detail` (
  ...
  CONSTRAINT `t_class_todo_detail_ibfk_1` FOREIGN KEY (`t_class_todo_id`) REFERENCES `t_class_todo` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_class_todo_detail_ibfk_2` FOREIGN KEY (`m_answer_type_id`) REFERENCES `m_answer_type` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_class_todo_exception
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_todo_exception`;
...
CREATE TABLE `t_class_todo_exception` (
  ...
  PRIMARY KEY (`id`),
  KEY `t_class_todo_id` (`t_class_todo_id`),
  CONSTRAINT `t_class_todo_exception_ibfk_1` FOREIGN KEY (`t_class_todo_id`) REFERENCES `t_class_todo` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_class_todo_option
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_class_todo_option`;
...
CREATE TABLE `t_class_todo_option` (
  ...
  PRIMARY KEY (`id`),
  KEY `t_class_todo_detail_id` (`t_class_todo_detail_id`),
  CONSTRAINT `t_class_todo_option_ibfk_1` FOREIGN KEY (`t_class_todo_detail_id`) REFERENCES `t_class_todo_detail` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_notification` (
  ...
  `out_id` int(11) unsigned DEFAULT NULL,
  `out_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '',
  `variable` text CHARACTER SET utf8 COLLATE utf8_bin,
  ...
  KEY `m_notification_type_id` (`m_notification_type_id`),
  CONSTRAINT `t_notification_ibfk_1` FOREIGN KEY (`sender_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE,
...
CREATE TABLE `t_notification_user` (
  ...
  PRIMARY KEY (`id`),
  KEY `sec_user_id` (`sec_user_id`),
  KEY `t_notification_user_ibfk_2` (`m_notification_type_id`),
  CONSTRAINT `t_notification_user_ibfk_1` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_notification_user_ibfk_2` FOREIGN KEY (`m_notification_type_id`) REFERENCES `m_notification_type` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_school` (
  ...
  UNIQUE KEY `code` (`code`),
  KEY `t_school_id` (`t_school_id`),
  CONSTRAINT `t_school_ibfk_1` FOREIGN KEY (`t_school_id`) REFERENCES `t_school` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_school_forum
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_school_forum`;
...
CREATE TABLE `t_school_forum` (
  ...
  KEY `t_school_id` (`t_school_id`),
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `t_school_forum_ibfk_1` FOREIGN KEY (`t_school_id`) REFERENCES `t_school` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_school_forum_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_school_forum_comment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_school_forum_comment`;
...
CREATE TABLE `t_school_forum_comment` (
  ...
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `t_school_forum_comment_ibfk_1` FOREIGN KEY (`t_school_forum_id`) REFERENCES `t_school_forum` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_school_forum_comment_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_school_forum_comment_mention
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_school_forum_comment_mention`;
...
CREATE TABLE `t_school_forum_comment_mention` (
  ...
  `updated_by` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `t_school_forum_comment_id` (`t_school_forum_comment_id`),
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `t_school_forum_comment_mention_ibfk_1` FOREIGN KEY (`t_school_forum_comment_id`) REFERENCES `t_school_forum_comment` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_school_forum_comment_mention_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `t_school_forum_mention`;
...
# Dump of table t_school_todo
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_school_todo`;
...
CREATE TABLE `t_school_todo` (
  ...
  KEY `sec_user_id` (`sec_user_id`),
  KEY `m_recurrent_id` (`m_recurrent_id`),
  CONSTRAINT `t_school_todo_ibfk_1` FOREIGN KEY (`t_school_id`) REFERENCES `t_school` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_school_todo_ibfk_2` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_school_todo_ibfk_3` FOREIGN KEY (`m_recurrent_id`) REFERENCES `m_recurrent` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_school_todo_answer
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_school_todo_answer`;
...
CREATE TABLE `t_school_todo_answer` (
  ...
  `updated_by` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `t_school_todo_id` (`t_school_todo_id`),
  KEY `t_school_todo_detail_id` (`t_school_todo_detail_id`),
  KEY `sec_user_id` (`sec_user_id`),
  CONSTRAINT `t_school_todo_answer_ibfk_1` FOREIGN KEY (`t_school_todo_id`) REFERENCES `t_school_todo` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_school_todo_answer_ibfk_2` FOREIGN KEY (`t_school_todo_detail_id`) REFERENCES `t_school_todo_detail` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_school_todo_answer_ibfk_3` FOREIGN KEY (`sec_user_id`) REFERENCES `sec_user` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_school_todo_detail
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_school_todo_detail`;
...
CREATE TABLE `t_school_todo_detail` (
  ...
  KEY `t_school_todo_id` (`t_school_todo_id`),
  KEY `m_answer_type_id` (`m_answer_type_id`),
  CONSTRAINT `t_school_todo_detail_ibfk_1` FOREIGN KEY (`t_school_todo_id`) REFERENCES `t_school_todo` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `t_school_todo_detail_ibfk_2` FOREIGN KEY (`m_answer_type_id`) REFERENCES `m_answer_type` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_school_todo_exception
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_school_todo_exception`;
...
CREATE TABLE `t_school_todo_exception` (
  ...
  PRIMARY KEY (`id`),
  KEY `t_school_todo_id` (`t_school_todo_id`),
  CONSTRAINT `t_school_todo_exception_ibfk_1` FOREIGN KEY (`t_school_todo_id`) REFERENCES `t_school_todo` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;



# Dump of table t_school_todo_option
# ------------------------------------------------------------

DROP TABLE IF EXISTS `t_school_todo_option`;
...
CREATE TABLE `t_school_todo_option` (
  ...
  PRIMARY KEY (`id`),
  KEY `t_school_todo_detail_id` (`t_school_todo_detail_id`),
  CONSTRAINT `t_school_todo_option_ibfk_1` FOREIGN KEY (`t_school_todo_detail_id`) REFERENCES `t_school_todo_detail` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
