            ...
            <div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <Card>
                            <CardTitle className="text-center" style={{marginTop:"5px"}}><h4>Group</h4></CardTitle>
                        ...
                        <div className="col-md-4">
                        <Card>
                            <CardTitle className="text-center" style={{marginTop:"5px"}}><h4>User</h4></CardTitle>
                        ...
                        <div className="col-md-4">
                        <Card>
                            <CardTitle className="text-center" style={{marginTop:"5px"}}><h4>Class</h4></CardTitle>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                        <Card>
                            <CardTitle className="text-center" style={{marginTop:"5px"}}><h4>Subject</h4></CardTitle>
                            ...
                            src={`${
                            process.env.PUBLIC_URL
                            }/assets/images/icon/subject.png`} 
                            alt="Card image cap" 
                            />
                            </Link>
                        </Card>
                        ...
                        <div className="col-md-4">
                        <Card>
                            <CardTitle className="text-center" style={{marginTop:"5px"}}><h4>Student</h4></CardTitle>
                            ...
                            src={`${
                            process.env.PUBLIC_URL
                            }/assets/images/icon/student3.png`} 
                            alt="Card image cap" 
                            />
                            </Link>
                        </Card>
