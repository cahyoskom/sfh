...
export function* getTaskOrtuList() {
  try {
    ...
    let response = [
      ...
      [
        false,
        "Membaca dan membuat rangkuman buku IPS halaman 19-28, foto hasil rangkuman lalu upload",
        2,
      ],
      [
        false,
        "Membaca dan membuat rangkuman buku IPA halaman 30-40, foto hasil rangkuman lalu upload",
        3,
      ],
    ];
...
export default function* rootSaga() {
  yield all([takeEvery(GET_TASK_ORTU_LIST, getTaskOrtuList)]);
}
