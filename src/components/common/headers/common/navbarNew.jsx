    ...
    return (
      <div>
        <nav id='main-nav'>
          ...
          {/*Horizontal menu*/}
          <ul id='main-menu' className='sm pixelstrap main-menu sm-horizontal' style={this.state.navClose}>
            <li>
            ...
            <li className='mega'>
              <Link to={`${process.env.PUBLIC_URL}/statuspesanan`}>{translate('shipment_status')}</Link>
            </li>
            <li>
...
export default connect(mapStateToProps, { postLogout })(withTranslate(NavbarTMS));
