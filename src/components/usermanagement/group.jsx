...
class Group extends Component {
    ...
    renderView (){
        let { adminState, adminSetModalFormUser, taskKepsekState, setStateTaskListFilter, setStateModalForm, kepsekGetTaskList } = this.props;
        ...
        return (
            <div>
                ...
                <section className="login-page section-b-space">
                    ...
                    <h3 className="text-left"><i className="mdi mdi-table-edit"/>GROUP</h3>
                        <div className="row">
                            ...
                            <div className="col-lg-9 right-login">
                                <div className="theme-card authentication-right">
                                    ...
                                    <MuiThemeProvider>
                                    <MUIDataTable
                                        title={<div>List Group <Button size="xs" color="primary" onClick={this.addGroup}><i className="fa fa-plus"></i>&nbsp;Add Group</Button></div>}
