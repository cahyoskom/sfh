      ...
      <div>
        <section className="school-member-page section-b-space">
              ...
              <ModalBody>
                <div className="form-group">
                  <TextValidator
                    ...
                    variant="outlined"
                    onChange={(e) =>
                      setModalConnectClass(e.target.id, e.target.value)
                    }
          ...
          <Modal isOpen={schoolState.createClassModal.show} centered>
            <ModalHeader
              toggle={() => setModalCreateSchoolClass("show", false)}
            >
              ...
              <ModalBody>
                <div className="form-group">
                  ...
                  <TextValidator
                    ...
                    variant="outlined"
                    onChange={(e) =>
                      setModalCreateSchoolClass(e.target.id, e.target.value)
                    }
                  ...
                  <Alert
                    ...
                    action={
                      <IconButton
                        ...
                        size="small"
                        onClick={() =>
                          setModalCreateSchoolClass("error", false)
                        }
                      >
                        <CloseIcon fontSize="inherit" />
                      </IconButton>
          ...
          <Modal isOpen={this.state.declineConfirmation} centered>
            <ModalBody>
              ...
              >
                <Grid item>
                  Apakah kamu yakin ingin menolak sambungkan kelas?
                </Grid>
