        ...
        <div>
                              ...
                              <Grid item xs={12} lg={8}>
                                ...
                                >
                                  <Button
                                    variant="contained"
                                    color="primary"
                                    onClick={this.toggleConfirmDuplicate}
                                  >
                                    Salin kelas
                                  </Button>
                                  <Button
                                    onClick={this.toggleEditClassForm}
                                    variant="contained"
                                    color="primary"
                                  >
                                    Edit
                            ...
                            <Grid item xs={12} lg={8}>
                              ...
                              >
                                ...
                                <Button
                                  variant="contained"
                                  color="primary"
                                  onClick={this.toggleConfirmUpdate}
                                >
                                  Simpan
                                </Button>
                              </Grid>
            ...
            <ModalBody>
              ...
              >
                ...
                <Button
                  ...
                  disableElevation
                  type="submit"
                  onClick={this.closeSuccessEditModal}
                >
                  Oke
                </Button>
              </Grid>
            ...
            <ModalBody>
              ...
              >
                ...
                <Button
                  ...
                  disableElevation
                  type="submit"
                  onClick={this.closeFailEditModal}
                >
                  Oke
                </Button>
              </Grid>
          ...
          <Modal isOpen={classState.editClass.confirmDelete}>
            <ModalBody>
              ...
              >
                <strong>
                  Apakah anda yakin mau menghapus kelas ini dan segala isinya?
                </strong>
                Anda akan kehilangan semua data yang berhubungan dengan kelas
                ini dan tidak dapat anda dapatkan kembali
              </Grid>
            </ModalBody>
            <ModalFooter>
              <Button
          ...
          <Modal isOpen={classState.editClass.confirmDuplicate}>
            <ModalBody>
              ...
              >
                <strong>
                  Apakah anda yakin mau menyalin kelas ini dan membuat kelas
                  baru?
                </strong>
                Anda akan membuat kelas baru dengan informasi dan anggota yang
                sama dengan kelas ini
              </Grid>
            </ModalBody>
            <ModalFooter>
              <Button
          ...
          <Modal isOpen={classState.editClass.duplicateSuccess}>
            ...
            <ModalFooter>
              ...
              <Button
                variant="contained"
                color="secondary"
                onClick={this.toggleSuccessDuplicate}
              >
                Tetap disini
              </Button>
            </ModalFooter>
