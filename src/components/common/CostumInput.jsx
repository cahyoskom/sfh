...
export default class CustomInput extends Component {
    ...
    render() {
        let { id = '', value, disable = false, name = '', label = '', placeholder = '', help = '', isInline = false,
            onFocus,
            onBlur,
            pattern,
            maxLength,
        ...
        return (
            <div className={parent}>
                ...
                <div className={inputs}>
                    ...
                    <Input pattern={pattern} placeholder={placeholder} name={name} value={value} disabled={disable}
                        onChange={(e) => {
