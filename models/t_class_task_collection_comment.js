...
module.exports = sequelize => {
  ...
  const options = {
    timestamps: false,
    tableName: 't_class_task_collection_comment',
    comment: '',
    indexes: [
      {
  ...
  const TClassTaskCollectionCommentModel = sequelize.define(
    't_class_task_collection_comment_model',
    attributes,
    options
  );
  return TClassTaskCollectionCommentModel;
};
