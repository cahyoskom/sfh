        ...
        return (
            <div>
                ...
                <section className="login-page section-b-space">
                    ...
                    <h3 className="text-left"><i className="mdi mdi-table-edit"/>SUBJECT</h3>
                        <div className="row">
                            ...
                            <div className="col-lg-9 right-login">
                                <div className="theme-card authentication-right">
                                    ...
                                    <MuiThemeProvider>
                                    <MUIDataTable
                                        title={<div>List Subject <Button size="sm" color="primary" onClick={this.addSubject}><i className="fa fa-plus"></i>&nbsp;Add Subject</Button></div>}
                                    ...
                                    <Form>
                                        ...
                                        <Col md={12}>
                                            ...
                                            <Input
                                                name="subject_name"
                                                id="subject_name"
                                                defaultValue={adminState.subject.form.subject_name}
                                                onChange= { (e) => adminSetModalFormSubject("subject_name", e.target.value)}
                                            />
                                            {/* {validator.message(
                                                "area_description",
