...
import { Grid, Box, Paper, Breadcrumbs, Typography } from '@material-ui/core';
                      ...
                      <Paper elevation={3}>
                        <Box p={3}>
                          <Grid container direction='column' justify='center' alignItems='center' spacing={3}>
                            <Grid item container direction='row' justify='center' alignItems='flex-start' m={2}>
                              <Grid item xs={5} lg={5}>
                                <h4>
                        ...
                        <Box p={3}>
                          <Grid container direction='column' justify='center' alignItems='center' spacing={2}>
                            ...
                            <Grid item container direction='row' justify='center' alignItems='center'>
                              ...
                              <Grid item xs={7} lg={7}>
                                <strong>{classState.classInfo.code}</strong>
                              </Grid>
                            </Grid>
                            <Grid item container direction='row' justify='center' alignItems='center'>
                              <Grid item xs={5} lg={5}>
                            ...
                            <Grid item container direction='row' justify='space-between' alignItems='flex-end'>
                              ...
                              <Grid item xs={7} lg={7}>
                                <Grid container direction='row' justify='flex-end' alignItems='center' spacing={2}>
                                  <Grid item>
                                    <Button onClick={this.toggleEditClassForm} variant='contained'>
                                      Batal
                                    </Button>
                                  </Grid>
                                  <Grid item>
